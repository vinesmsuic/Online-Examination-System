...
function btnConfirmReleaseExam() {
	...
	if (document.getElementById("course-name").value == ",,"){
		document.getElementById("errorMessage1").value = "Please select a course.";
	} else {
